...
class CameraSensorHelperOv64b40 : public CameraSensorHelper
{
public:
	CameraSensorHelperOv64b40()
	{
		blackLevel_ = 4096;
		gain_ = AnalogueGainLinear{ 1, 0, 0, 128 };
	}
};
REGISTER_CAMERA_SENSOR_HELPER("ov64b40", CameraSensorHelperOv64b40)
...
class CameraSensorHelperS5k3p3 : public CameraSensorHelper
{
public:
	CameraSensorHelperS5k3p3()
	{
		blackLevel_ = 4096;
		gain_ = AnalogueGainLinear{ 1, 0, 0, 128 };
	}
};
REGISTER_CAMERA_SENSOR_HELPER("s5k3p3", CameraSensorHelperS5k3p3)
